...
export default function HeroVideo() { 
    ...
    return (
        <div className="h-screen relative">
            ...
            <div className="absolute left-0 top-0 w-full h-full flex flex-col justify-center items-center gap-4 text-slate-900 lg:gap-6">
                <img alt="logo" src="/logo.png" className='md:w-1/4 w-1/3'/>
