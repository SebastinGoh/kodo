                ...
                <div className="bg-white rounded-b-lg pb-4 shadow-lg">
                    ...
                    <div className="max-w-6xl mx-auto flex flex-col items-center justify-center gap-8 text-center p-6">
                        ...
                        <div className="flex flex-col gap-4 w-full">
                            <button onClick={() => addToCart(product, quantity)} id={id} className="border-2 border-slate-900 rounded-full font-bold w-full h-12 flex items-center justify-center py-2 px-8 hover:bg-pink lg:text-lg">
                                ADD TO CART
                            </button>
