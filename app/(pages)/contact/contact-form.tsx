...
const ContactForm: FC = () => {
    ...
    const openEmailConfirmModal = useOverlayStore((state) => state.openEmailConfirmModal);
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          ></textarea>
          {isLoading 
            ? <button disabled={true} className='bg-beige self-end flex items-center rounded-lg py-3 px-4 font-semibold outline-none opacity-50 cursor-not-allowed'>
            ...
            : <button className='bg-beige self-end rounded-lg py-3 px-8 font-semibold outline-none'>Submit</button>
          }
        </form>
      );
    };
