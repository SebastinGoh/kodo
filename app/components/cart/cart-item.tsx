...
export default function CartItem({ product }: Props) {
    ...
    // Recover the store action to remove items from the cart
     ...
     return (
      <div className='flex items-center justify-between gap-4 mb-2 border-b-2 p-4'>
        <Image className="" src={`/product/${product.images[0]}`} width={60} height={60} alt={product.name} />
