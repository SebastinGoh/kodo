        ...
        <div className="flex-1 flex opacity-100 left-0">
            <div className='flex flex-col px-8 pb-8'>
                <div className="flex-1 flex flex-col items-center justify-center gap-4">
                    <div role="status">
                        <svg aria-hidden="true" className="fill-slate-900 text-green inline w-8 h-8 mr-2 text-gray-200 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="sr-only">Payment in Progress...</span>
                    </div>
